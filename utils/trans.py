...
coco_format_save_path='F:\object-detection\datasets\VOCdevkit\VOC2007\labels\\'   #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='F:\object-detection\datasets\VOCdevkit\VOC2007\labels\\name.txt'     #类别文件，一行一个类
yolo_format_annotation_path='F:\object-detection\datasets\VOCdevkit\VOC2007\Annotations_txt\\'  #yolo格式标签所在文件夹
img_pathDir='F:\object-detection\datasets\VOCdevkit\VOC2007\images\\val\\'    #图片所在文件夹
