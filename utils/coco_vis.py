...
train_json = 'C:\\HQQ\SSOD\\MixPL\data\\coco/annotations/instances_test2017.json'
train_path = 'C:\\HQQ\SSOD\\MixPL\data\\coco/train2017/'
...
if __name__ == "__main__":
   visualization_bbox1(5, train_json, train_path)
